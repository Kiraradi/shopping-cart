...
class Cart {
  ...
  getProductQuantity() {
    return this.products.reduce((productQuantity, product) => productQuantity + product.quantity, 0);
  }
  getSum() {
...
;// CONCATENATED MODULE: ./src/js/getProductWord.js
function getProductWord(productQuantity) {
  if (Math.floor(productQuantity / 10) != 1 && productQuantity % 10 === 1) {
    return "товар";
  } else if (Math.floor(productQuantity / 10) != 1 && (productQuantity % 10 === 2 || productQuantity % 10 === 3 || productQuantity % 10 === 4)) {
    return "товара";
  }
  return "товаров";
}
;// CONCATENATED MODULE: ./src/js/cartController.js
...
class CartController {
  ...
  drawUi() {
    const sectionCartHeaderClearEl = this.container.querySelector("#cart__clear");
  ...
  toggleInstallation() {
    const installationCheckboxEl = this.container.querySelector("#installation__checkbox");
    const installationStatus = this.container.querySelector("#installation__status");
  ...
  getProductItemCounter(product) {
    ...
    productItemCounterQuantityEl.classList.add("product-item__counter-quantity");
    ...
    productItemCounterMinusEl.addEventListener("click", () => {
      ...
      this.updateProduct(product, productItemCounterQuantityEl, productItemCounterMinusEl, productItemPriceEl);
    });
  ...
  updateProduct(product, productItemCounterQuantityEl, productItemCounterMinusEl, productItemPriceEl) {
    productItemCounterQuantityEl.textContent = product.quantity;
    if (product.quantity === 0) {
      productItemCounterMinusEl.setAttribute("disabled", "true");
    } else if (product.quantity > 0 && productItemCounterMinusEl.getAttribute("disabled")) {
  ...
  setProductSum(product, productPriceEl) {
    ...
    const productItemSumEl = productItemEl.querySelector(".product-item__price");
    productItemSumEl.textContent = product.getSum() || product.price;
  }
  setProductsSum() {
    const informationCartAllPriceEl = this.container.querySelector(".information-cart__full-price");
    const orderAmountAllPriceEl = this.container.querySelector("#order-amount__full-price");
    const costGoodsAllPriceEl = this.container.querySelector("#cost-goods__full-price");
    informationCartAllPriceEl.textContent = orderAmountAllPriceEl.textContent = costGoodsAllPriceEl.textContent = this.cart.getSum();
  }
  setProductsQuantity() {
    const productQuantityEl = this.container.querySelector("#product-quantity");
    const informationCartProductsQuantityEl = this.container.querySelector("#information-cart__products-quantity");
    const quantityGoodsQuantityEl = this.container.querySelector("#quantity-goods__quantity");
    const quantity = this.cart.getProductQuantity();
    productQuantityEl.textContent = informationCartProductsQuantityEl.textContent = `${quantity} ${getProductWord(quantity)}`;
...
;// CONCATENATED MODULE: ./src/js/viewedProduct.js
class ViewedProduct {
  constructor(obj) {
    this.id = obj.id;
    this.name = obj.name;
...
;// CONCATENATED MODULE: ./src/swiperController.js
...
class SwiperController {
  ...
  drawUi() {
    ...
    this.viewedProducts.forEach(product => swiperWrapperEl.appendChild(this.getProductItem(product)));
  ...
  createSwiper() {
    ...
    const swiperPaginationEl = this.container.querySelector(".swiper-pagination");
    const swiper = new core(swiperEl, {
      slidesPerView: 4,
      spaceBetween: 20,
...
const swiperController = new SwiperController(document.querySelector("#viewed-products"), viewedProducts);
